...
@Database(entities = [TareaEntity::class, EventoEntity::class, AsignaturaEntity::class, CalificacionEntity::class], version = 13, exportSchema = false)
abstract class TareasDatabase :RoomDatabase(){
    ...
    abstract fun getCalificacionesDao():CalificacionesDao
}